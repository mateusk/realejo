...
TOPICS = [
    ...
    "kindness personified as a quirky character who always forgets their keys but never forgets to help a friend",
    "a grumpy cat that secretly spreads kindness while pretending to be aloof",
    "an unlikely hero",
    "a magical library that only appears to those who need it most",
    "a mysterious door that leads to a world of forgotten dreams",
    "a story in verse about a pair of mismatched socks that bring warmth and comfort to those in need",
    "a clumsy angel who is always getting lost on the U-Bahn",
    "a mischievous fairy whose pranks always end up making people laugh",
    "a forgetful wizard accidentally casts spells that make everyone around them kinder",
    "a story in verse about a cloud that refuses to rain on rush hour an weekends",
    "everyday kindness",
    "an ode to unproductiveness",
    "one thing that makes you happy",
    "accents",
    "a lullaby for my plushies",
    "an ode to the undone",
    "a delicious orgasm",
